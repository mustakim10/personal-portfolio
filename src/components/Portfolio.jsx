                        ...
                        portfolios.map(({ id, src }) => (
                            <div key={id} className="shadow-md shadow-gray-600 rounded-lg">
                                ...
                                <div className="flex items-center font-bold text-gray-200 justify-center">
                                    ...
                                    <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">Client Code</button>
                                    <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105">Server Code</button>
                                </div>
                            </div>
                        ))
                    }
